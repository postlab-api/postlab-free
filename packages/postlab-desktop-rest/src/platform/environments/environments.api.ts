...
//   runGQLQuery,
//   runGQLSubscription,
// } from '@postlab/common/helpers/backend/GQLClient'
...
import type { TEnvironment } from '@postlab/types'

export const createUserEnvironment = (name: string, variables: string) =>
  runMutation<CreateUserEnvironmentMutation, CreateUserEnvironmentMutationVariables, ''>(
    CreateUserEnvironmentDocument,
    {
      name,
      variables,
...
export const updateUserEnvironment = (id: string, { name, variables }: TEnvironment) =>
  runMutation<UpdateUserEnvironmentMutation, UpdateUserEnvironmentMutationVariables, ''>(
    UpdateUserEnvironmentDocument,
    {
      id,
      name,
...
export const deleteUserEnvironment = (id: string) =>
  runMutation<DeleteUserEnvironmentMutation, DeleteUserEnvironmentMutationVariables, ''>(
    DeleteUserEnvironmentDocument,
    {
      id,
    },
...
export const clearGlobalEnvironmentVariables = (id: string) =>
  runMutation<ClearGlobalEnvironmentsMutation, ClearGlobalEnvironmentsMutationVariables, ''>(
    ClearGlobalEnvironmentsDocument,
    {
      id,
    },
